...
> ​	xfolds:
>
> * give effective making techniques (compare)
> * scaling law to give appropriately sized parameter model
> * to multiple adapters training or to single encoder decoder training
> *  compare results with similarly sized models.
